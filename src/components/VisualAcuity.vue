        ...
        getNextImage(event){
            if(this.currentTest.tests.length === 1){
                ...
                if(finalResult <= 50){
                    ...
                    this.$store.commit('saveToGeneralReport',{testName:this.currentTest.name ,testReport:this.$store.state.allTests[0].report.abnormalTwoEye})
                }else if(finalResult <= 70){
                    this.$store.commit('saveToGeneralReport',{testName:this.currentTest.name ,testReport:this.$store.state.allTests[0].report.abnormalOneEye})
                    //this.report = this.$store.state.allTests[0].report.abnormalOneEye
                }else{
                    this.$store.commit('saveToGeneralReport',{testName:this.currentTest.name ,testReport:this.$store.state.allTests[0].report.normal})
